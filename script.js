...
function createUserList({ avatar, name, time }, index) {
  ...
  // to change chat Data based on click...............................
  ...
  function selectTheme(event) {
    ...
    if (color === "Change theme") {
      r.style.setProperty("--my-mssg", "#05a705");
    } else {
  ...
  function changeBg(event) {
    ...
    switch (bg) {
      case "Change background":
        ...
        break;
      case "image1":
        r.style.setProperty("--background-img", 'url("/assets/america.jpg")');
       
        break;
      case "image2":
        r.style.setProperty("--background-img", 'url("/assets/avengers.jpg")');
      break;
      case "image3":
        r.style.setProperty("--background-img", 'url("/assets/infinity.jpg")');
      break;
    }
  }
